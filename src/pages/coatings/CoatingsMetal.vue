...
export default {
	...
	methods: {
		ConfirmEditEventHandler(){
			this.editCoatingFormConfirmHandler(COATING_TYPES.METAL.key);
		},

		getPageData(page){
			this.listCoatings({type: COATING_TYPES.METAL.key, page});
		},
	},
	mounted(){
		this.listCoatings({type: COATING_TYPES.METAL.key, page: 1});
